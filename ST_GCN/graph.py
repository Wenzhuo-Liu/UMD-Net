...
class Graph():
    # def __init__(self, dataset, graph, labeling, graphsingle='physical', num_person_out=1, max_hop=2, dilation=1,
    #              normalize=True, threshold=0.5, **kwargs):
    def __init__(self,  dataset='AIDE', labeling='spatial', num_person_out=1, max_hop=2, dilation=1,
                 normalize=True, threshold=0.5, **kwargs):
